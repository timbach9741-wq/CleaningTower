...
export default function CTASection() {
  const [showBottomQuote, setShowBottomQuote] = useState(false);
  ...
  return (
    <section className="py-20 bg-blue-600 text-white text-center">
      <div className="max-w-4xl mx-auto px-4 flex flex-col items-center">
        ...
        {!showBottomQuote ? (
          <button 
            onClick={() => setShowBottomQuote(true)}
          ...
          <div className="mt-4 w-full flex justify-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            <QuoteWidget />
          </div>
        )}
      </div>
