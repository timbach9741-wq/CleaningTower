      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group relative">
            ...
            <div className="p-6">
              <p className="text-slate-600 mb-4 text-sm leading-relaxed break-keep">서랍장 안쪽, 배수구 트랩 등 보이지 않는 곳의 먼지까지 완전 탈거하여 고압세척합니다.</p>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group relative">
            ...
            <div className="p-6">
              <p className="text-slate-600 mb-4 text-sm leading-relaxed break-keep">유해 건축 자재에서 뿜어져 나오는 포름알데히드를 피톤치드 연무 시공으로 완벽 차단합니다.</p>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group relative">
            <div className="h-56 overflow-hidden relative">
              ...
              <h3 className="absolute bottom-4 left-6 text-2xl font-bold text-white z-20">에어컨/세탁기 청소</h3>
            </div>
            <div className="p-6">
              <p className="text-slate-600 mb-4 text-sm leading-relaxed break-keep">필터 교체와 다릅니다. 내부 냉각핀과 드럼통 안쪽의 찌든 세균과 곰팡이를 날려버립니다.</p>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group relative border-2 border-transparent hover:border-blue-100">
            ...
            <div className="h-56 overflow-hidden relative">
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent z-10 transition-opacity group-hover:opacity-80"></div>
              <img src="/images/living_room_cleaning.webp" loading="lazy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="집 정기 청소" />
              <h3 className="absolute bottom-4 left-6 text-2xl font-bold text-white z-20">집 정기 청소</h3>
            </div>
            <div className="p-6">
              <p className="text-slate-600 mb-4 text-sm leading-relaxed break-keep">입주 상태를 그대로! 검증된 호텔식 매뉴얼로 각 가정마다 전담 매니저가 지정되어 방문합니다.</p>
