...
export default function Footer() {
  return (
    <footer className="snap-section-short bg-[#f8f9fc] pt-16 pb-8 border-t border-slate-200">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="pt-8 border-t border-slate-200">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-xs text-slate-400 mb-4">
            ...
            <span className="hidden sm:inline">|</span>
            <span>이메일: <a href="mailto:cjdthxkdnj1@naver.com" className="hover:text-blue-600 transition-colors">cjdthxkdnj1@naver.com</a></span>
          </div>
