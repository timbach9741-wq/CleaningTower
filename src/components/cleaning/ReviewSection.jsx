...
const reviews = [
  ...
  },
  {
    ...
    content: "구축 빌라로 이사 오게 되었는데, 전 세입자가 관리를 너무 안 해서 주방 후드랑 화장실 타일 곰팡이가 심각했습니다. 과연 이게 지워질까 반신반의했는데, 청소타워 전문 살균 세척 장비가 지나가니 새집처럼 변하더라고요. 화장실 하수구 악취까지 다 잡아주셔서 너무 만족스럽습니다. 돈이 전혀 아깝지 않은 퀄리티입니다.",
    rating: 5
  },
  {
    id: 3,
