...
const reviews = [
  {
    ...
    content: "신축 아파트로 입주하면서 미세분진이랑 새집증후군이 제일 걱정이었어요. 갓난아기가 있어서 돈이 조금 더 들더라도 확실한 곳에서 하려고 싹클을 선택했습니다. 팀장님이 친환경 세제 쓰시는 거 직접 보여주시고, 벽지나 수납장 안쪽까지 손으로 쓸어봐도 먼지 하나 묻어나오지 않게 완벽하게 해주셨어요. 덕분에 안심하고 바로 입주했습니다. 강력 추천해요!",
    rating: 5
  },
  {
    id: 2,
    ...
    content: "구축 빌라로 이사 오게 되었는데, 전 세입자가 관리를 너무 안 해서 주방 후드랑 화장실 타일 곰팡이가 심각했습니다. 과연 이게 지워질까 반신반의했는데, 싹클 스팀 청소 장비가 지나가니 새집처럼 변하더라고요. 화장실 하수구 악취까지 다 잡아주셔서 너무 만족스럽습니다. 돈이 전혀 아깝지 않은 퀄리티입니다.",
    rating: 5
  },
  {
    id: 3,
  ...
  },
  {
    ...
    content: "원룸이라 다른 곳은 예약하기도 눈치 보였는데, 싹클은 정말 친절하게 상담해 주셨어요. 평수가 작아도 에어컨 필터, 세탁기 주변, 냉장고 내부까지 풀옵션 가전 찌든 때를 전부 다 제거해 주셨습니다. 혼자 사는 직장인 분들께 정말 추천드려요. 이사 첫날부터 기분 좋게 꿀잠 잤습니다.",
    rating: 5
  },
  {
    id: 5,
    ...
    content: "강아지를 키우다 보니 바닥에 화학 세제가 남을까 봐 항상 걱정이었어요. 싹클은 친환경 인증 세제만 쓴다고 해서 믿고 맡겼습니다. 청소 끝나고 강아지가 집안을 막 돌아다녀도 독한 냄새 하나 없이 쾌적했어요. 펫 프렌들리한 청소 업체 찾으시면 무조건 여기입니다.",
    rating: 5
  },
  {
    id: 6,
    ...
    content: "집이 넓어서 청소 인원이 많이 필요했는데, 싹클은 구역별 전문가분들이 오셔서 각자 맡은 곳을 체계적으로 진행해 주시더라고요. 특히 대리석 바닥 코팅이나 샹들리에 같은 까다로운 부분도 흠집 없이 깔끔하게 작업해 주셨습니다. 검수할 때 팀장님이 워낙 깐깐하게 체크하셔서 제가 지적할 부분이 없었네요.",
    rating: 5
  },
  {
    id: 7,
    ...
    content: "올 리모델링 끝내고 났더니 온 집안이 하얀 시멘트 가루와 나무 톱밥 투성이였습니다. 손으로 한 번 닦고 포기했는데, 싹클 청소팀이 다녀가니 공사 흔적이 완전히 사라졌어요. 수납장 탈거해서 안쪽 숨은 먼지까지 다 빼주시는 거 보고 감동했습니다. 인테리어 후 청소는 필수네요.",
    rating: 5
  },
  {
    id: 8,
    ...
    content: "집 보러 갈 때 가구에 가려져 있던 베란다 벽면 곰팡이를 이사 당일에 발견하고 멘붕이 왔어요. 다행히 싹클 팀장님이 특수 약품으로 곰팡이 뿌리까지 다 제거해 주시고, 억제 코팅까지 해주셔서 완전 새하얗게 변했습니다. 추가 비용이 전혀 아깝지 않은 최고의 서비스였습니다.",
    rating: 5
  },
  {
    id: 9,
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              보이지 않는 곳까지 완벽하게. 싹클의 프리미엄 서비스를 경험하신 분들의 이야기입니다.
            </p>
          </motion.div>
        </div>
