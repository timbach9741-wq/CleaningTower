...
const REGIONS = [
  { key: 'gangnam', label: '서울 강남구, 서울 서초구, 서울 송파구, 서울 강동구', short: '강남' },
  { key: 'mapo', label: '서울 마포구, 서울 용산구, 서울 성동구, 서울 광진구', short: '마포' },
  { key: 'gangseo', label: '서울 강서구, 서울 영등포구, 서울 양천구, 서울 구로구', short: '강서' },
  { key: 'nowon', label: '서울 노원구, 서울 도봉구, 서울 강북구, 서울 성북구', short: '노원' },
  { key: 'eunpyeong', label: '서울 은평구, 서울 서대문구, 서울 종로구, 서울 중구', short: '은평' },
  { key: 'gyeonggi_south', label: '경기 수원시 장안구, 경기 성남시 분당구, 경기 용인시 수지구', short: '수원' },
  { key: 'gyeonggi_hwaseong', label: '경기 화성시, 경기 오산시', short: '화성' },
  { key: 'gyeonggi_ansan', label: '경기 안산시 상록구, 경기 시흥시, 경기 광명시', short: '안산' },
  { key: 'gyeonggi_sw', label: '경기 안양시 동안구, 경기 과천시, 경기 군포시', short: '안양' },
  { key: 'gyeonggi_west', label: '경기 부천시, 경기 김포시', short: '부천' },
  { key: 'gyeonggi_north', label: '경기 고양시 일산동구, 경기 파주시', short: '고양' },
  { key: 'gyeonggi_east', label: '경기 구리시, 경기 남양주시, 경기 하남시', short: '구리' },
  { key: 'incheon', label: '인천 전지역', short: '인천' },
  { key: 'daejeon', label: '대전 대덕구, 세종 세종특별자치시, 충남 천안시 동남구, 충북 청주시 상당구', short: '대전' },
  { key: 'daegu', label: '대구 남구, 대구 달서구, 경북 포항시 남구, 경북 경주시', short: '대구' },
  { key: 'busan', label: '부산 강서구, 부산 금정구, 울산 남구, 경남 창원시 의창구', short: '부산' },
  { key: 'gwangju', label: '광주 광산구, 광주 남구, 전남 목포시, 전북 전주시 완산구', short: '광주' },
  { key: 'gangwon', label: '강원 춘천시, 강원 원주시, 제주 제주시, 제주 서귀포시', short: '강원' },
];
...
const PM_NAMES = [
  ...
  '{r} 마스터클린','골드클린 {r}점','{r} 프로케어','{r} 클린파워',
...
const TAGS = [
  ...
  ['#하루한집','#사장님직접','#AS확실'],['#인테리어청소','#섬세한케어','#살균소독'],
  ['#고객만족1위','#살균소독','#꼼꼼한청소'],['#부부청소단','#AS보장','#베란다특화'],
...
const REVIEWS = [
  ...
  { author: '조○은', rating: 5, text: '살균 소독 효과 대박! 강력 추천.' },
  ...
  { author: '유○찬', rating: 5, text: '전문 장비라 때가 싹! 확실히 다르네요.' },
