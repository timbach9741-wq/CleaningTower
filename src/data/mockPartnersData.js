...
const REGIONS = [
  { key: 'gangnam', label: '서울 강남구, 서울 서초구, 서울 송파구, 서울 강동구, 서울 동작구, 서울 관악구', short: '강남' },
  { key: 'mapo', label: '서울 마포구, 서울 용산구, 서울 성동구, 서울 광진구, 서울 중구, 서울 종로구', short: '마포' },
  { key: 'gangseo', label: '서울 강서구, 서울 영등포구, 서울 양천구, 서울 구로구, 서울 금천구', short: '강서' },
  { key: 'nowon', label: '서울 노원구, 서울 도봉구, 서울 강북구, 서울 성북구, 서울 중랑구, 서울 동대문구', short: '노원' },
  { key: 'eunpyeong', label: '서울 은평구, 서울 서대문구, 서울 종로구, 서울 중구', short: '은평' },
  { key: 'gyeonggi_south', label: '경기 수원시 장안구, 경기 수원시 권선구, 경기 수원시 팔달구, 경기 수원시 영통구, 경기 성남시 수정구, 경기 성남시 중원구, 경기 성남시 분당구, 경기 용인시 처인구, 경기 용인시 기흥구, 경기 용인시 수지구', short: '수원' },
  { key: 'gyeonggi_hwaseong', label: '경기 화성시, 경기 오산시, 경기 평택시, 경기 안성시', short: '화성' },
  { key: 'gyeonggi_ansan', label: '경기 안산시 상록구, 경기 안산시 단원구, 경기 시흥시, 경기 광명시', short: '안산' },
  { key: 'gyeonggi_sw', label: '경기 안양시 동안구, 경기 안양시 만안구, 경기 과천시, 경기 군포시, 경기 의왕시', short: '안양' },
  { key: 'gyeonggi_west', label: '경기 부천시, 경기 김포시', short: '부천' },
  { key: 'gyeonggi_north', label: '경기 고양시 일산동구, 경기 고양시 덕양구, 경기 고양시 일산서구, 경기 파주시, 경기 의정부시, 경기 동두천시, 경기 양주시, 경기 포천시, 경기 연천군', short: '고양' },
  { key: 'gyeonggi_east', label: '경기 구리시, 경기 남양주시, 경기 하남시, 경기 광주시, 경기 이천시, 경기 여주시, 경기 가평군, 경기 양평군', short: '구리' },
  { key: 'incheon', label: '인천 전지역', short: '인천' },
  { key: 'daejeon', label: '대전 전지역, 세종 전지역, 충남 전지역, 충북 전지역', short: '대전' },
  { key: 'daegu', label: '대구 전지역, 경북 전지역', short: '대구' },
  { key: 'busan', label: '부산 전지역, 울산 전지역, 경남 전지역', short: '부산' },
  { key: 'gwangju', label: '광주 전지역, 전남 전지역, 전북 전지역', short: '광주' },
  { key: 'gangwon', label: '강원 전지역, 제주 전지역', short: '강원' },
];
