...
export default function Quote() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col">
      ...
      {/* 헤더 */}
      <header className="sticky top-0 z-50 bg-slate-950/90 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="flex items-center justify-between px-4 py-3 max-w-6xl mx-auto w-full">
          <button 
            onClick={handlePrev} 
            className="flex items-center justify-center p-1.5 -ml-1.5 text-slate-400 active:bg-white/5 rounded-full transition-colors"
          >
          ...
          {isB2BLoggedIn && (
            <button
              ...
              className="text-[11px] text-slate-500 font-bold px-2 py-1 rounded-lg hover:bg-white/10 transition-colors whitespace-nowrap"
            >
              로그아웃
            </button>
          )}
      ...
      <main className={`flex-1 w-full mx-auto ${step === 0 ? 'max-w-6xl p-0 pb-24' : 'max-w-2xl p-5 pb-28 lg:p-8 lg:pb-32'} flex flex-col relative overflow-hidden`}>
        ...
        {step > 0 && (
        <div className="mb-8">
          <div className="flex justify-between text-[10px] font-bold text-slate-600 mb-2.5 px-0.5 tracking-wider uppercase">
            <span className={step >= 1 ? 'text-amber-400' : ''}>면적/단가</span>
            <span className={step >= 2 ? 'text-amber-400' : ''}>세부사항</span>
            <span className={step >= 3 ? 'text-amber-400' : ''}>일정/주소</span>
            <span className={step >= 4 ? 'text-amber-400' : ''}>정보입력</span>
            <span className={step >= 5 ? 'text-amber-400' : ''}>견적완료</span>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 0 && (
              ...
              >
                ...
                <div className="relative px-5 pt-10 pb-12 lg:pt-24 lg:pb-20 text-center overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-b from-amber-500/5 via-amber-500/[0.02] to-transparent pointer-events-none"></div>
                  <div className="hidden lg:block absolute top-[10%] left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-amber-500/10 blur-[100px] pointer-events-none" />
                  <div className="relative z-10">
                    ...
                    <p className="text-sm lg:text-lg text-slate-400 font-medium break-keep leading-relaxed max-w-md lg:max-w-lg mx-auto">
                      ...
                      청소타워가 <strong className="text-amber-400">사전에 차단</strong>해드립니다.
                    </p>
                  </div>
                </div>
                ...
                <div className="px-5 lg:px-8 mb-8 lg:mb-12">
                  ...
                  <div className="text-center mb-5 lg:mb-8">
                    <span className="inline-block px-4 py-1.5 lg:px-5 lg:py-2 rounded-full bg-white/[0.04] border border-white/[0.08] text-[11px] lg:text-sm font-bold text-slate-400 tracking-wider uppercase">왜 청소타워인가?</span>
                  </div>

                  <div className="relative grid grid-cols-2 gap-3 lg:gap-0">
                    {/* VS 뱃지 - 데스크톱 */}
                    <div className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-14 h-14 rounded-full bg-slate-900 border-2 border-white/10 shadow-lg items-center justify-center shadow-xl">
                      <span className="text-sm font-black text-slate-400">VS</span>
                    </div>

                    {/* 타사 */}
                    <div className="bg-gradient-to-br from-red-950/40 to-red-950/20 border border-red-500/20 rounded-2xl lg:rounded-3xl lg:rounded-r-none p-4 lg:p-10">
                      <div className="flex items-center gap-2 lg:gap-3 mb-4 lg:mb-7">
                        <div className="w-8 h-8 lg:w-12 lg:h-12 rounded-full bg-red-500/15 flex items-center justify-center">
                          <span className="text-red-400 text-sm lg:text-2xl">✗</span>
                        </div>
                        <span className="text-xs lg:text-xl font-black text-red-400">타사 업체</span>
                      </div>
                      <ul className="space-y-3 lg:space-y-5">
                        {['그냥 청소만 합니다', '보수는 별도 업체 부르세요', '하자 발견해도 내 일 아닙니다', '입주 후? 연락 안 됩니다'].map((t, i) => (
                          <li key={i} className="flex items-center gap-2 lg:gap-3">
                            ...
                            <span className="text-red-300 text-[11px] lg:text-lg font-semibold break-keep">{t}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                    ...
                    {/* 청소타워 */}
                    <div className="bg-gradient-to-br from-emerald-950/40 to-emerald-950/20 border border-emerald-500/20 rounded-2xl lg:rounded-3xl lg:rounded-l-none p-4 lg:p-10 relative overflow-hidden">
                      ...
                      <div className="flex items-center gap-2 lg:gap-3 mb-4 lg:mb-7 relative z-10">
                        <div className="w-8 h-8 lg:w-12 lg:h-12 rounded-full bg-emerald-500/15 flex items-center justify-center">
                          <span className="text-emerald-400 text-sm lg:text-2xl">✓</span>
                        </div>
                        <span className="text-xs lg:text-xl font-black text-emerald-400">청소타워</span>
                      </div>
                      <ul className="space-y-3 lg:space-y-5 relative z-10">
                        {['청소하면서 하자까지 잡습니다', '실리콘·마루·벽지·장판 원스톱', '소비자가 말하기 전에 먼저 합니다', '사장님 평판을 지켜드립니다'].map((t, i) => (
                          <li key={i} className="flex items-center gap-2 lg:gap-3">
                            <span className="w-5 h-5 lg:w-6 lg:h-6 rounded-full bg-emerald-500/15 flex items-center justify-center shrink-0">
                              <span className="text-emerald-400 text-[10px] lg:text-xs font-bold">✓</span>
                            </span>
                            <span className="text-emerald-300 text-[11px] lg:text-lg font-semibold break-keep">{t}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <div className="p-4 bg-white">
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="text-base font-black text-slate-900">마루콕 시공</h4>
                            <p className="text-[11px] text-slate-500 font-medium mt-0.5">마루 찍힘·긁힘 복원 · 틈새 충진</p>
                          </div>
                          <span className="text-[10px] font-bold text-amber-700 bg-amber-50 border border-amber-300 px-2.5 py-1 rounded-full">무상</span>
                        </div>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="relative aspect-[16/9] bg-slate-900 overflow-hidden">
                        ...
                        {/* 터치 안내 */}
                        <div className="absolute bottom-3 right-3 z-10">
                          <span className="inline-block px-2.5 py-1 rounded-full bg-black/60 backdrop-blur-sm text-[10px] font-bold text-slate-300">
                      ...
                      <div className="p-4 bg-slate-900">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[10px] font-bold text-amber-400 bg-amber-500/10 border border-amber-500/30 px-2.5 py-1 rounded-full">무상</span>
                        </div>
                      </div>
                    </button>
                ...
                <div className="px-5 lg:px-8 mb-6 lg:mb-10">
                  <div className="bg-gradient-to-r from-amber-500/[0.07] to-blue-500/[0.05] border border-amber-500/20 rounded-2xl lg:rounded-3xl p-5 lg:p-10 text-center relative overflow-hidden">
                    <div className="hidden lg:block absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-amber-500/10 rounded-full blur-[80px] pointer-events-none" />
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-slate-500 text-sm mt-3 leading-relaxed">
                    선택하신 <strong className="text-blue-600">{cleaningType} 청소</strong> 맞춤 단가가 적용됩니다.
                  </p>
                </div>
                
                <div className="space-y-7 flex-1">
                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-3">🧹 청소 종류</label>
                    <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/30 shadow-lg shadow-amber-500/5 flex items-center justify-between mb-6">
                      <div className="flex flex-col">
                        <span className="text-[15px] font-bold text-amber-300">프리미엄 입주청소</span>
                        <span className="text-[11px] mt-0.5 text-amber-400/60">인테리어 공사완료 후 분진이 많은 현장 · 무상 보수 포함</span>
                      </div>
                      <span className="text-xs font-bold px-3 py-1.5 rounded-lg bg-amber-500 text-slate-900 shadow-sm">평당 2.0만</span>
                    </div>
                  </div>

                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-3">💡 주거 형태</label>
                      ...
                      {['아파트', '빌라', '오피스텔'].map(type => (
                        <button
                          ...
                          className={`py-3.5 rounded-xl text-sm font-bold transition-all active:scale-95 ${
                            houseType === type 
                            ? 'bg-amber-500 text-slate-900 shadow-lg shadow-amber-500/25 ring-2 ring-amber-400/50' 
                            : 'bg-white/[0.04] text-slate-400 border border-white/[0.08] active:bg-white/[0.08]'
                          }`}
                        >
                          {type}
                        </button>
                  ...
                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-3">🚚 이사 형태 특이사항</label>
                    <div className="space-y-3">
                      <button
                        ...
                        className={`w-full p-4 rounded-xl text-sm font-bold transition-all active:scale-[0.98] flex items-center justify-between border ${
                          isBetweenCleaning 
                          ? 'bg-amber-500/10 shadow-sm shadow-amber-500/10 border-amber-500/40' 
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col text-left -mt-0.5">
                            <span className={`${isBetweenCleaning ? 'text-amber-300' : 'text-slate-400'} text-[14px]`}>
                              당일 이사 후 바로 청소
                            </span>
                            <span className={`${isBetweenCleaning ? 'text-amber-400/60' : 'text-slate-500'} text-[11px] font-normal mt-0.5`}>
                              (사이청소 10시 투입)
                            </span>
                          </div>
                        </div>
                        <span className={isBetweenCleaning ? 'text-amber-400 font-bold' : 'text-slate-500'}>
                          +100,000원
                        </span>
                      </button>
                  ...
                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-3">📏 공급 면적 (평)</label>
                    <div className="flex items-center justify-between bg-white/[0.03] border border-white/[0.08] rounded-xl p-4 focus-within:border-amber-500/50 focus-within:bg-amber-500/5 transition-all">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="text-slate-600 text-[10px] mb-0.5">단가</span>
                        <span className="text-amber-400 text-xs font-bold bg-amber-500/10 px-2 py-1 rounded-lg border border-amber-500/20 whitespace-nowrap flex-shrink-0">
                          평당 2.0만원
                        </span>
                      </div>
                    </div>
                ...
                {/* 중간 견적 안내 박스 */}
                <div className="mt-8 bg-white/[0.03] p-4 rounded-xl flex flex-col border border-white/[0.06] shadow-lg gap-3">
                   ...
                   <div className="flex justify-between items-end pt-1">
                     <span className="text-amber-400 font-bold text-[15px] mb-1">총 결제 예정 금액</span>
                ...
                <div className="space-y-8 flex-1 overflow-y-auto pr-1 pb-4">
                  {optionCategories.map((cat, catIdx) => (
                    <div key={catIdx} className="space-y-4">
                      <h3 className="text-xl font-bold text-white border-b border-white/[0.08] pb-2">
                        {cat.category}
                      </h3>
                      <div className="space-y-3">
                        {cat.items.map(opt => {
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex flex-col gap-1 flex-1">
                                  <span className={`text-sm ${count > 0 ? 'text-amber-300 font-bold' : 'text-slate-400'} break-keep`}>
                                    {opt.label}
                                  </span>
                                  {priceDisplay && (
                                ...
                                {(cat.type === 'toggle' || isNotice) ? (
                                  <div className={`w-6 h-6 rounded flex items-center justify-center border transition-colors shrink-0 ${
                                    count > 0 ? 'bg-amber-500 border-amber-500 text-white' : 'bg-white/[0.04] border-slate-600 text-transparent'
                                  }`}>
                                    <span className="material-symbols-outlined text-[14px] font-bold">check</span>
                                  </div>
                                ) : (
                                  <div 
                                    className={`flex items-center gap-3 rounded-lg p-1 border transition-colors shrink-0 ${count > 0 ? 'bg-white/[0.04] border-amber-500/20' : 'bg-white/[0.03] border-white/[0.06]'}`}
                                    onClick={(e) => e.stopPropagation()}
                                  >
                                    <button 
                                      onClick={() => updateOptionCount(opt.id, -1)}
                                      disabled={count === 0}
                                      className={`w-8 h-8 rounded flex items-center justify-center transition-colors ${count > 0 ? 'bg-white/[0.06] text-slate-300 active:bg-white/10 hover:bg-white/10' : 'text-slate-600 cursor-not-allowed'}`}
                                    >
                                      <span className="material-symbols-outlined text-lg">remove</span>
                                    </button>
                                    <span className={`w-4 text-center font-bold ${count > 0 ? 'text-amber-300' : 'text-slate-500'}`}>{count}</span>
                                    <button 
                                      onClick={() => updateOptionCount(opt.id, 1)}
                                      className="w-8 h-8 rounded bg-amber-500/15 flex items-center justify-center text-amber-400 active:bg-amber-500/25 hover:bg-amber-500/20"
                                    >
                              ...
                              {isNotice && (
                                <div className="mt-3 pt-3 border-t border-slate-200 text-xs text-slate-500 space-y-1.5 leading-relaxed break-keep">
                                  <div className="font-bold text-slate-600">💡 추가 비용이 발생하는 경우 예시:</div>
                              ...
                              {count > 0 && !isNotice && (
                                <div className="mt-3 pt-3 border-t border-amber-500/20 flex items-center justify-between">
                                  <span className="text-xs text-amber-400/70">항목 추가 금액</span>
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="space-y-6 flex-1">
                  {isOpenPostcode ? (
                    <div className="bg-slate-900 rounded-xl overflow-hidden pb-1 relative transition-all shadow-[0_0_30px_rgba(0,0,0,0.5)] border border-white/[0.08]">
                       <div className="flex justify-between items-center p-3 bg-white/[0.04] border-b border-white/[0.06]">
                          <span className="text-slate-300 font-bold text-sm ml-1">주소 검색</span>
                          <button onClick={() => setIsOpenPostcode(false)} className="text-slate-500 p-1 hover:bg-white/10 rounded-md transition-colors flex items-center justify-center">
                    ...
                    <div>
                      <label className="block text-slate-400 text-sm font-semibold mb-2">📍 방문할 주소</label>
                      <div className="space-y-3">
                        <div 
                          onClick={() => setIsOpenPostcode(true)}
                          className="w-full bg-white/[0.03] border border-white/[0.08] hover:border-amber-500/30 rounded-xl px-4 py-4 text-base transition-all flex items-center justify-between cursor-pointer active:scale-[0.99] active:bg-white/[0.06]"
                        >
                          <span className={address ? "text-white font-medium" : "text-slate-500"}>
                            {address || "터치하여 도로명/지번 주소 검색"}
                          </span>
                          <span className={`${address ? 'text-amber-400' : 'text-slate-500'} material-symbols-outlined text-xl`}>search</span>
                        </div>
                        {address && (
                          <motion.div
                          ...
                          >
                            <input
                              ...
                              className="w-full bg-white/[0.03] border border-white/[0.08] hover:border-amber-500/30 focus:border-amber-500/50 rounded-xl px-4 py-4 text-base text-white placeholder-slate-500 focus:outline-none transition-all focus:bg-amber-500/5 mt-1"
                            />
                          </motion.div>
                        )}
                      </div>
                  ...
                  {!isOpenPostcode && (
                    ...
                    >
                      <label className="block text-slate-400 text-sm font-semibold mb-2">
                        📅 시공 희망 날짜
                        <span className="block text-amber-400/70 font-normal text-[11px] mt-1">
                      ...
                      >
                        ...
                        />
                        <div className={`w-full bg-white/[0.03] border ${cleaningDate ? 'border-amber-500/50 bg-amber-500/5 shadow-[0_0_15px_rgba(245,158,11,0.1)]' : 'border-white/[0.08] group-hover:border-amber-500/30 group-active:bg-white/[0.06]'} rounded-xl px-4 py-4 text-base transition-all flex items-center justify-between pointer-events-none`}>
                          <span className={cleaningDate ? 'text-amber-300 font-bold tracking-wide' : 'text-slate-500'}>
                            {cleaningDate ? cleaningDate.replace(/-/g, '. ') : '터치하여 날짜 선택'}
                          </span>
                          <span className={`material-symbols-outlined ${cleaningDate ? 'text-amber-400' : 'text-slate-500 group-hover:text-amber-400/70'} transition-colors`}>
                            calendar_month
                          </span>
                        </div>
                      </div>
                      ...
                      {/* 시공 희망 시간 선택 UI */}
                      <div className="mt-6">
                        <label className="block text-slate-400 text-sm font-semibold mb-3">⏰ 시공 희망 시간</label>
            ...
            {step === 4 && (
              ...
              >
                ...
                <div className="space-y-6 flex-1">
                  <div>
                    <label className={`block text-sm font-semibold mb-2 flex items-center gap-1.5 text-amber-400/80`}>
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl px-4 py-4 text-base text-white placeholder-slate-500 focus:outline-none transition-all bg-amber-500/5 border border-amber-500/20 focus:border-amber-500/50 focus:bg-amber-500/10`}
                    />
                  </div>

                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-2">📞 담당자 연락처 <span className="text-rose-400">*</span></label>
                    <input
                      type="tel"
                      placeholder="예) 010-0000-0000"
                      value={contactInfo}
                      onChange={(e) => setContactInfo(e.target.value)}
                      className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-4 text-base text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-all focus:bg-amber-500/5"
                    />
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-slate-400 text-sm font-semibold mb-2">바닥재 종류</label>
                        ...
                        {['장판', '마루'].map(type => (
                          <button
                            ...
                            className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${
                              floorType === type ? 'bg-amber-500 text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-300'
                            }`}
                          >
                            {type}
                          </button>
                    ...
                    <div>
                      <label className="block text-slate-400 text-sm font-semibold mb-2">물청소 가능 여부</label>
                      <div className="flex bg-white/[0.03] rounded-xl border border-white/[0.08] p-1">
                        {['가능', '불가능'].map(type => (
                          <button
                            key={type}
                            ...
                            className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${
                              waterCleaning === type ? 'bg-amber-500 text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-300'
                            }`}
                          >
                            {type}
                          </button>
                  ...
                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-2">주차 가능 여부</label>
                    <div className="flex bg-white/[0.03] rounded-xl border border-white/[0.08] p-1">
                      {['가능', '불가능'].map(type => (
                        <button
                          key={type}
                          ...
                          className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${
                            parking === type ? 'bg-amber-500 text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-300'
                          }`}
                        >
                          {type}
                        </button>
                  ...
                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-2">엘리베이터 유무</label>
                    <div className="flex bg-white/[0.03] rounded-xl border border-white/[0.08] p-1">
                      {['있음', '없음'].map(type => (
                        <button
                          key={type}
                          ...
                          className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${
                            elevator === type ? 'bg-amber-500 text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-300'
                          }`}
                        >
                          {type}
                        </button>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-slate-400 text-sm font-semibold mb-2">공동현관 비밀번호</label>
                      <input
                        type="text"
                        placeholder="예) *1234#"
                        value={commonEntrancePw}
                        onChange={(e) => setCommonEntrancePw(e.target.value)}
                        className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-all focus:bg-amber-500/5"
                      />
                    </div>
                    <div>
                      <label className="block text-slate-400 text-sm font-semibold mb-2">세대 현관 비밀번호</label>
                      <input
                        type="text"
                        placeholder="예) 1234*"
                  ...
                  <div>
                    <label className="block text-slate-400 text-sm font-semibold mb-2">✏️ 추가 요청사항 및 메모</label>
                    <textarea
                      placeholder="시공 현장의 특이사항이나 특히 신경써야 할 부분이 있다면 자세히 적어주세요."
                      value={memos}
                      onChange={(e) => setMemos(e.target.value)}
                      rows={4}
                      className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-4 text-base text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-all resize-none focus:bg-amber-500/5"
                    ></textarea>
                  </div>

                  {/* 필수 개인정보 제3자 제공 동의 */}
                  <div className="bg-white/[0.03] rounded-xl p-4 mt-6 border border-white/[0.06]">
                    <label className="flex items-start gap-3 cursor-pointer select-none">
                      <input 
                        type="checkbox" 
                        checked={isAgreedPersonalInfo}
                        onChange={(e) => setIsAgreedPersonalInfo(e.target.checked)}
                        className="mt-1 w-5 h-5 rounded border-white/20 bg-slate-900 text-amber-500 focus:ring-amber-500 accent-amber-500 shrink-0"
                      />
                      <div className="flex-1 text-xs text-slate-400 leading-relaxed break-keep text-left">
                        <span className="font-bold text-amber-400">[필수]</span> 개인정보 제3자 제공 동의 및 책임 한계 안내에 동의합니다.
                        <button 
                          type="button" 
                          onClick={() => setShowPrivacyModal(true)} 
                          className="text-amber-400 hover:text-amber-300 underline ml-1.5 font-bold"
                        >
                          [상세 약관 보기]
                        </button>
                      </div>
              ...
              >
                <div className="text-center mb-6 pt-2">
                  <motion.div 
                    ...
                    className="w-16 h-16 bg-amber-500/15 text-amber-400 rounded-full flex items-center justify-center mx-auto mb-4 border border-amber-500/20"
                  >
                ...
                {/* 영수증 형태의 결과 영수증 */}
                <div className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-5 mb-5 shadow-xl relative overflow-hidden">
                   ...
                   <div className="relative z-10">
                     ...
                     <div className="flex justify-between items-center border-b border-white/[0.08] pb-4 mb-4">
                      ...
                      <div className="space-y-3 pb-4 border-b border-dashed border-white/[0.08] mb-4">
                        ...
                        {Object.keys(selectedOptions).length > 0 && (
                          <div className="flex flex-col gap-1">
                            ...
                            <div className="pl-2.5 border-l-2 border-amber-500/30 space-y-1.5 mt-1 pb-1">
                              {Object.entries(selectedOptions).map(([optId, count]) => {
                                ...
                                return option ? (
                                  <div key={optId} className="flex justify-between text-[13px] text-slate-500">
                                    ...
                                    <span className="text-slate-600">{option.price > 0 ? `+${price.toLocaleString()}원` : '확인'}</span>
                                  </div>
                                ) : null;
                              })}
                            </div>
                        ...
                        <div className="mt-3 bg-white/[0.04] rounded-lg p-3 border border-white/[0.06]">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            <span className="text-[11px] bg-white/[0.04] text-slate-400 px-2 py-1 rounded border border-white/[0.06]">바닥: {floorType}</span>
                            <span className="text-[11px] bg-white/[0.04] text-slate-400 px-2 py-1 rounded border border-white/[0.06]">물청소: {waterCleaning}</span>
                            <span className="text-[11px] bg-white/[0.04] text-slate-400 px-2 py-1 rounded border border-white/[0.06]">주차: {parking}</span>
                            <span className="text-[11px] bg-white/[0.04] text-slate-400 px-2 py-1 rounded border border-white/[0.06]">엘리베이터: {elevator}</span>
                          </div>
                        </div>
                     ...
                     <div className="flex justify-between items-end pt-2">
                        <span className="text-amber-400 text-base font-bold mb-1">최종 예상 결제액</span>
                        <div className="text-right">
                           <span className="text-[32px] font-black text-white leading-none">
                             {totalPriceIncVat.toLocaleString()}
                           </span>
                           <span className="text-amber-400 text-base ml-1 font-bold">원</span>
                        </div>
                     </div>
                   </div>
                </div>
                ...
                {/* 신뢰도 문구 */}
                <div className="bg-white/[0.03] rounded-xl p-4 mb-6 flex flex-col gap-1.5 border border-white/[0.06]">
                  <p className="text-[13px] text-slate-400 leading-relaxed text-center font-medium break-keep">
                ...
                <div className="space-y-3 mt-auto">
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 text-slate-900 font-bold py-4 rounded-xl text-lg shadow-[0_0_20px_rgba(245,158,11,0.3)] transition-all active:scale-95 flex items-center justify-center gap-2"
                  >
      ...
      <AnimatePresence>
        {step < 5 && (
          <motion.div 
            ...
            animate={{ y: 0 }} 
            exit={{ y: 100 }}
            className="fixed bottom-0 left-0 w-full bg-slate-950/95 backdrop-blur-xl border-t border-white/[0.06] shadow-[0_-4px_30px_rgba(0,0,0,0.3)] px-4 py-4 z-40"
            ...
            <div className="max-w-2xl mx-auto relative flex flex-col gap-3">
              ...
              <button
                ...
                className={`w-full font-bold py-4 rounded-xl text-lg transition-all active:scale-[0.98] ${
                  step === 0
                    ? 'bg-gradient-to-r from-amber-500 to-amber-400 active:from-amber-600 active:to-amber-500 text-slate-900 shadow-[0_8px_20px_rgba(245,158,11,0.25)]'
                    : 'bg-gradient-to-r from-amber-500 to-amber-400 active:from-amber-600 active:to-amber-500 text-slate-900 shadow-[0_8px_20px_rgba(245,158,11,0.25)]'
                }`}
              >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-4xl max-h-[80vh] overflow-y-auto shadow-2xl p-6 relative flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4 text-xs text-slate-600 leading-relaxed overflow-y-auto pr-1 max-h-[50vh] break-keep text-left">
                ...
                <div className="border-t border-slate-200 pt-3 mt-3">
                  ...
                  <p className="text-slate-600 font-medium">청소타워는 청소 서비스의 통신판매중개자이며 거래 당사자가 아닙니다. 파트너 대표님이 독자적으로 제공하는 청소 서비스의 품질, 시공 미이행, 현장 파손, 하자보수 및 배상 책임은 실제 청소를 수행한 파트너사에게 있으며 본사는 중개 역할만 수행합니다. 동의를 거부하실 수 있으나 동의하지 않으실 경우 견적 요청 및 매칭이 제한됩니다.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-slate-200 flex gap-2">
              ...
              <button 
                ...
                className="px-5 py-3 bg-slate-200 hover:bg-slate-650 text-slate-600 text-sm font-bold rounded-xl transition-colors"
              >
                닫기
              </button>
            </div>
        ...
        {showB2BLoginModal && (
          ...
          >
            <motion.div
              ...
              onClick={e => e.stopPropagation()}
              className="w-full max-w-md bg-white border-t border-slate-200 rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.1)] sm:rounded-3xl p-6 pb-8 sm:mb-0"
            >
              {/* 핸들바 */}
              ...
              <form onSubmit={handleB2BLogin} className="space-y-3">
                <input
                  type="text"
                  required
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200/60 rounded-xl text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-sm font-medium"
