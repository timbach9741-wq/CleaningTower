...
export default function Quote() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900 font-sans flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm">
        <div className="flex items-center justify-between px-4 py-3 max-w-6xl mx-auto w-full">
          <button 
            onClick={handlePrev} 
            className="flex items-center justify-center p-1.5 -ml-1.5 text-slate-500 active:bg-slate-100 rounded-full transition-colors"
          >
          ...
          <AnimatePresence mode="wait">
            ...
            {b2bTab === 'apply' && step === 0 && (
              ...
              >
                ...
                <div className="px-5 lg:px-8 py-10 max-w-4xl mx-auto w-full border-t border-slate-100 mt-10">
                ...
                <div className="px-5 lg:px-8 py-12 max-w-4xl mx-auto w-full">
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-xl lg:text-3xl font-black text-slate-900 tracking-tight mt-3">
                      {sessionStorage.getItem('b2b_partner_type') === 'interior' ? '2' : '3'}. 안심하고 맡기는 3대 보장제
                    </h2>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <div className="p-4 bg-white">
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="text-base font-black text-slate-900">실리콘 보수</h4>
                            <p className="text-[11px] text-slate-500 font-medium mt-0.5">곰팡이 제거 후 항균 실리콘 재시공</p>
                          </div>
                          <span className="text-[10px] font-bold text-amber-700 bg-amber-50 border border-amber-300 px-2.5 py-1 rounded-full">무상</span>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div className="p-4 bg-white">
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="text-base font-black text-slate-900">장판 이음매 용착</h4>
                            <p className="text-[11px] text-slate-500 font-medium mt-0.5">이음매 벌어짐 · 들뜸 열용착 보수</p>
                          </div>
                          <span className="text-[10px] font-bold text-amber-700 bg-amber-50 border border-amber-300 px-2.5 py-1 rounded-full">무상</span>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div className="p-4 bg-white">
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="text-base font-black text-slate-900">벽지콕 시공</h4>
                            <p className="text-[11px] text-slate-500 font-medium mt-0.5">벽지 찍힘 · 긁힘 · 구멍 복원 보수</p>
                          </div>
                          <span className="text-[10px] font-bold text-amber-700 bg-amber-50 border border-amber-300 px-2.5 py-1 rounded-full">무상</span>
                        </div>
                      </div>
            ...
            {b2bTab === 'apply' && step === 1 && (
              ...
              >
                ...
                <div className="space-y-7 flex-1">
                  <div>
                    ...
                    <div className="p-4 rounded-xl bg-blue-50 border-2 border-blue-500 shadow-lg shadow-blue-200/30 flex items-center justify-between mb-6">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[11px] mt-0.5 text-blue-500/80">{sessionStorage.getItem('b2b_partner_type') === 'realestate' ? '부동산 고객 감동 서비스! 입주 전 청소 · 점검 · 보수 한 번에' : '인테리어 공사완료 후 분진이 많은 현장 · 무상 보수 포함'}</span>
                      </div>
                  ...
                  <div>
                    <label className="block text-slate-700 text-sm font-semibold mb-3">💡 주거 형태</label>
                          ...
                          {['원룸', '분리형 원룸', '투룸', '쓰리룸 이상', '복층', '기타'].map(sub => (
                             <button
                               ...
                               className={`px-3 py-2 rounded-lg text-xs font-bold transition-all ${
                                 ...
                                 : 'bg-slate-100 text-slate-600 border border-slate-200 active:bg-white/20'
                               }`}
                             >
                               {sub}
                             </button>
                  ...
                  <div>
                    <label className="block text-slate-700 text-sm font-semibold mb-3">🚚 이사 형태 특이사항</label>
                  ...
                  <div>
                    <label className="block text-slate-700 text-sm font-semibold mb-2">📐 공급 면적</label>
                    {/* m² → 평 변환기 */}
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                {(cat.type === 'toggle' || isNotice) ? (
                                  <div className={`w-6 h-6 rounded flex items-center justify-center border transition-colors shrink-0 ${
                                    count > 0 ? 'bg-blue-500 border-blue-500 text-white' : 'bg-white/50 border-slate-500 text-transparent'
                                  }`}>
                                  ...
                                  >
                                    <button 
                                      ...
                                      disabled={count === 0}
                                      className={`w-8 h-8 rounded flex items-center justify-center transition-colors ${count > 0 ? 'bg-slate-50 text-slate-600 active:bg-slate-100 hover:bg-slate-100' : 'text-slate-600 cursor-not-allowed'}`}
                                    >
            ...
            {b2bTab === 'apply' && step === 3 && (
              ...
              >
                ...
                <div className="space-y-6 flex-1">
                  {isOpenPostcode ? (
                    <div className="bg-white rounded-xl overflow-hidden pb-1 relative transition-all shadow-[0_0_30px_rgba(0,0,0,0.5)] border border-slate-200">
                    ...
                    <div>
                      <label className="block text-slate-700 text-sm font-semibold mb-2">📍 방문할 주소</label>
                      <div className="space-y-3">
                        <div 
                        ...
                        {address && (
                          ...
                          >
                            <input
                              ...
                              className="w-full bg-slate-50 border border-white/15 hover:border-blue-500/50 focus:border-blue-500 rounded-xl px-4 py-4 text-base text-slate-900 placeholder-slate-400 focus:outline-none transition-all focus:bg-blue-500/5 mt-1"
                            />
                          </motion.div>
                        )}
                      </div>
                  ...
                  {!isOpenPostcode && (
                    ...
                    >
                      <label className="block text-slate-700 text-sm font-semibold mb-2">
                        📅 시공 희망 날짜
                        <span className="block text-blue-600 font-normal text-[11px] mt-1">
                      ...
                      {/* 시공 희망 시간 선택 UI */}
                      <div className="mt-6">
                        <label className="block text-slate-700 text-sm font-semibold mb-3">⏰ 시공 희망 시간</label>
                ...
                <div className="space-y-6 flex-1">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl px-4 py-4 text-base text-slate-900 placeholder-slate-400 focus:outline-none transition-all ${
                        ...
                        : 'bg-slate-50 border border-white/15 focus:border-blue-600 focus:bg-blue-500/5'
                      }`}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-white/15 rounded-xl px-4 py-4 text-base text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 transition-all focus:bg-blue-500/5"
                    />
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-slate-700 text-sm font-semibold mb-2">바닥재 종류</label>
                    ...
                    <div>
                      <label className="block text-slate-700 text-sm font-semibold mb-2">물청소 가능 여부</label>
                      <div className="flex bg-slate-50 rounded-xl border border-slate-200 p-1">
                        {['가능', '불가능'].map(type => (
                          <button
                            key={type}
                  ...
                  <div>
                    <label className="block text-slate-700 text-sm font-semibold mb-2">주차 가능 여부</label>
                    <div className="flex bg-slate-50 rounded-xl border border-slate-200 p-1">
                      {['가능', '불가능'].map(type => (
                        <button
                          key={type}
                  ...
                  <div>
                    <label className="block text-slate-700 text-sm font-semibold mb-2">엘리베이터 유무</label>
                    <div className="flex bg-slate-50 rounded-xl border border-slate-200 p-1">
                      {['있음', '없음'].map(type => (
                        <button
                          key={type}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-slate-700 text-sm font-semibold mb-2">공동현관 비밀번호</label>
                      <input
                        type="text"
                        placeholder="예) *1234#"
                        value={commonEntrancePw}
                        onChange={(e) => setCommonEntrancePw(e.target.value)}
                        className="w-full bg-slate-50 border border-white/15 rounded-xl px-4 py-3 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 transition-all focus:bg-blue-500/5"
                      />
                    </div>
                    <div>
                      <label className="block text-slate-700 text-sm font-semibold mb-2">세대 현관 비밀번호</label>
                      <input
                        type="text"
                        placeholder="예) 1234*"
                  ...
                  <div>
                    <label className="block text-slate-700 text-sm font-semibold mb-2">✏️ 추가 요청사항 및 메모</label>
                    <textarea
                      placeholder="시공 현장의 특이사항이나 특히 신경써야 할 부분이 있다면 자세히 적어주세요."
                      value={memos}
                      onChange={(e) => setMemos(e.target.value)}
                      rows={4}
                      className="w-full bg-slate-50 border border-white/15 rounded-xl px-4 py-4 text-base text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 transition-all resize-none focus:bg-blue-500/5"
                    ></textarea>
                  </div>

                  {/* 필수 개인정보 제3자 제공 동의 */}
                  <div className="bg-white/80 rounded-xl p-4 mt-6 border border-white/5">
                    <label className="flex items-start gap-3 cursor-pointer select-none">
                      ...
                      />
                      <div className="flex-1 text-xs text-slate-600 leading-relaxed break-keep text-left">
                        <span className="font-bold text-blue-600">[필수]</span> 개인정보 제3자 제공 동의 및 책임 한계 안내에 동의합니다.
                        <button 
                          type="button" 
                          onClick={() => setShowPrivacyModal(true)} 
                          className="text-blue-600 hover:text-blue-300 underline ml-1.5 font-bold"
                        >
                          [상세 약관 보기]
                        </button>
                      </div>
              ...
              >
                <div className="text-center mb-6 pt-2">
                  <motion.div 
                    ...
                    className="w-16 h-16 bg-blue-500/20 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 border border-blue-500/30"
                  >
                    <span className="material-symbols-outlined text-4xl">check_circle</span>
                  </motion.div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-2">사업자 견적서 발급 완료!</h2>
                  <p className="text-slate-500 text-sm">입력해주신 정보 기반의 산출 금액입니다.</p>
                </div>

                {/* 영수증 형태의 결과 영수증 */}
                <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-5 mb-5 shadow-xl relative overflow-hidden">
                   {/* 장식용 텍스쳐 */}
                   ...
                   <div className="relative z-10">
                     ...
                     <div className="space-y-3 pb-4 border-b border-dashed border-slate-200 mb-4">
                        ...
                        {/* 비비용성 정보 요약 */}
                        <div className="mt-3 bg-white/50 rounded-lg p-3 border border-white/5">
                ...
                <div className="bg-blue-50/70 rounded-xl p-4 mb-4 border border-blue-100 text-left">
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-black text-blue-700 tracking-wider select-all text-xl md:text-2xl">신협 131-022-991902</span>
                        <button
                          type="button"
                          onClick={handleCopyAccount}
                          className="px-3 py-1.5 bg-white hover:bg-slate-100 text-slate-700 rounded-lg text-sm font-bold transition-all border border-slate-300 shadow-sm active:scale-95 whitespace-nowrap"
                        >
                          복사
                        </button>
                      </div>
                    ...
                    <div className="flex flex-col gap-2 border-t border-slate-200/60 pt-3">
                      ...
                      <span className="text-slate-900 font-bold text-lg md:text-xl">주식회사 청소타워</span>
                    </div>
                  </div>
                </div>
      ...
      <AnimatePresence>
        {step < 5 && (
          <motion.div 
            ...
            animate={{ y: 0 }} 
            exit={{ y: 100 }}
            className="fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] px-4 py-4 z-40"
