    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 p-4 sticky top-0 z-50 transition-all">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <span className="text-xl font-black text-slate-900 tracking-tight">청소타워 새집증후군 케어</span>
      ...
      <main className="flex-1 w-full bg-slate-50">
        <section className="relative w-full h-[400px] md:h-[500px]">
          <div className="absolute inset-0 bg-slate-900">
            <img src="/service_syndrome.webp" alt="새집증후군" className="w-full h-full object-cover opacity-50" />
          </div>
