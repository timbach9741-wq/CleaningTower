    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-slate-500 font-medium">
          하루 평균 50건 이상의 오더, 안정적인 수익을 약속합니다.
        </p>
      </div>
                ...
                <div className="space-y-5 flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2">
                    <div>
                      ...
                      <select className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none focus:bg-white text-slate-700">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-slate-700 mb-1">주력 서비스 <span className="text-slate-400 font-normal text-[10px]">(선택)</span></label>
                      <select className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none focus:bg-white text-slate-700">
                        <option value="">선택</option>
                        <option value="입주/이사">신축 입주 및 이사청소</option>
                        <option value="거주">거주 청소</option>
                        <option value="상가/사무실">상가 및 사무실 정기</option>
                      </select>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="bg-slate-50 w-full rounded-2xl p-6 text-left mb-8 border border-slate-200">
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-200 flex justify-between items-center">
                    <span className="text-slate-500 text-sm font-bold">입금하실 금액</span>
            ...
            {step === 4 && (
              ...
              >
                ...
                <p className="text-slate-500 mb-6 break-keep leading-relaxed font-medium">
                  환영합니다! 아래 발급된 접속 정보를 보관해주세요.<br/>
                  해당 아이디와 비밀번호로 앱에 로그인하실 수 있습니다.
                </p>
